...
2{,}166 vs 2{,}960), and the gap widens fast: by 10 turns it is less than half (3{,}499 vs
7{,}700) and by 15 turns it is roughly one third (5{,}202 vs 16{,}533), because rule-trigger
...
The answer-quality columns are within the $n=20$ noise band of Section~\ref{sec:audits}
(no CI); we read the rule trigger as quality-neutral.
...
\begin{figure}[!t]
  ...
  ($T=6,10,15$). With the free rule-based Echidna (blue), RbD-Compress falls below the uncached
  naive agent (red) by 6 turns and the gap widens to $\sim$$3\times$ by 15 turns; the
