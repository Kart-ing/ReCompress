...
\thispagestyle{empty}
\rhead{\textit{}}
\fancyhead[LO]{ReCompress: Query-Aware Rewriting and Multi-Turn Compression}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.92\linewidth]{cross_benchmark_bars.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.92\linewidth]{delta_ci.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\linewidth]{dots_hotpotqa.png}\hfill
  \includegraphics[width=0.49\linewidth]{dots_2wiki.png}\\[2pt]
  \includegraphics[width=0.49\linewidth]{dots_musique.png}\hfill
  \includegraphics[width=0.49\linewidth]{dots_squad.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.92\linewidth]{tokens_vs_f1.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.92\linewidth]{token_trajectory_line.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\linewidth]{multiturn_tokens.png}\hfill
  \includegraphics[width=0.49\linewidth]{multiturn_f1.png}
...
(Figure~\ref{fig:variant}). The protected-buffer variant holds answer quality
better as the checkpoint is squeezed, consistent with the hypothesis that
isolating bridging facts into an uncompressed buffer lets the rest of the
checkpoint be compressed more aggressively at equal task accuracy. We report
this as a directional ablation at $n=20$ rather than a significance claim ---
the sample is small and the per-ratio confidence intervals overlap.

\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\linewidth]{variant_compare.png}
  \caption{Protected-buffer ablation: QA-F1 vs.\ checkpoint compression ratio
  for Variant A (protected trauma buffer) and Variant B (single summary) at
  matched total budget. Variant A degrades more gracefully as the checkpoint
  tightens.}
  \label{fig:variant}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\linewidth]{cross_solver_bars.png}\hfill
  \includegraphics[width=0.49\linewidth]{mask_answer_bars.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\linewidth]{distill_trajectory.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\linewidth]{latency_bars.png}
